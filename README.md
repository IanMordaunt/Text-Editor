# Text-Editor
 ...
 This application provides the user with a clean looking space to put together text and have it saved to the browsers local storage.
  ...
  This app is a place where the user can put together any text or narrative and will be saved to the browsers local storage
  ...
  No licenses where used in the creation of this application
